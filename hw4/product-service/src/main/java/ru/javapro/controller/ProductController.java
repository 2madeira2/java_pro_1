...
public class ProductController {
    ...
    public ProductDto decreaseProductBalance(@PathVariable Long productId, @RequestBody ProductDecreaseBalanceRequest request) {
        return productService.decreaseProductBalance(productId, request);
    }
}
